...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IKaanGTokenInterface extends Interface {
    getFunction(nameOrSignature: "mintFromBuild"): FunctionFragment;
  ...
  export interface IKaanGToken extends BaseContract {
    
    connect(runner?: ContractRunner | null): IKaanGToken;
    waitForDeployment(): Promise<this>;

    interface: IKaanGTokenInterface;
